...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "border-input focus-within:border-main has-aria-invalid:border-destructive dark:bg-input/30 dark:has-aria-invalid:border-destructive/50 -destructive/40 flex min-h-9 flex-wrap items-center gap-1.5 rounded-md border bg-transparent bg-clip-padding px-2.5 py-1.5 text-sm shadow-xs transition-[color,box-shadow] has-aria-invalid:border-red-600 has-data-[slot=combobox-chip]:px-1.5",
        className,
      )}
      {...props}
    />
